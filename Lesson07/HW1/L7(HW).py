...
write_json(data=r.json(), file_name='HW1/getMe.json')

# 2. Записываем все сообщения в файл "messages.json"
result_get_updates = get_updates()
write_json(data=result_get_updates, file_name="HW1/messages.json")

# 3. Получаем последнее сообщение и записываем его в "last_message.json"
result_get_message = get_message()
write_json(data=result_get_message, file_name="HW1/last_message.json")
